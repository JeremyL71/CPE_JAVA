package atelier3IRC2.checkersGameLauncher;


import atelier3IRC2.checkersGameController.Controller;
import atelier3IRC2.checkersGameGui.GuiConfig;
import atelier3IRC2.checkersGameGui.View;
...
public class LauncherAtelier3IRC2 extends Application {
	...
	public void start (Stage primaryStage) {
		...
		primaryStage.setTitle("Ceci est la fenetre de mon jeu de dames - Version Atelier trop relou");
		primaryStage.show();
	}
